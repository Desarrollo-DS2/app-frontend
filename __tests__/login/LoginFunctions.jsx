...
import { login, handleLoginError } from '../../app/_providers/authUser/AuthUserActions';
...
jest.mock('../../app/_providers/authUser/AuthUserActions', () => {
  const originalModule = jest.requireActual('../../app/_providers/authUser/AuthUserActions');
  return {
    __esModule: true,
    ...originalModule,
    login: jest.fn(),
...
describe('On Finish', () => {
  it('handles successful login', async () => {
    ...
    expect(login).toHaveBeenCalledWith(dispatch, { email, password }, recaptchaRef.current.getValue());
